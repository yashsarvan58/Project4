...
<div className='border-2  bg-white rounded-lg shadow-lg w-[500px] h-[400px] p-20  gap-10 '>
...
<  label className="flex items-baseline text-gray-700"></label>
  ...
  <div>
    <button type='submit' className='border-2 rounded bg-blue-300 mt-2 w-full p-1'>Login</button>
  </div>
  </div>
</div>
